...
import getContentDetails from '@salesforce/apex/DemoSearch.getContentDetails';
import deleteContentDocument from '@salesforce/apex/DemoSearch.deleteContentDocument';
import getLoginURL from '@salesforce/apex/DemoSearch.getLoginURL';
...
export default class ContentManager extends NavigationMixin(LightningElement) {
    ...
    handleDeleteFiles(row){
        ...
        .catch(error => {
            console.error('**** handle sync   error **** \n ',error)
        })
        .finally(()=>{
